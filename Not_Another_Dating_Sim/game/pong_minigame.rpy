    ...
    class PongDisplayable(renpy.Displayable):
        ...
        def render(self, width, height, st, at):
            ...
            if abs(self.by - self.computery) <= cspeed:
                ...
                self.computery = max(self.computery, self.COURT_TOP+self.PADDLE_HEIGHT/2)
                self.computery = min(self.computery, self.COURT_BOTTOM-self.PADDLE_HEIGHT/2)
            ...
            if self.by < ball_top:
                ...
                if not self.stuck:
                    renpy.sound.play("sounds/pong_minigame_sounds/pong_beep.opus", channel=0)
            ...
            def paddle(px, py, hotside):
                ...
                if py - self.PADDLE_HEIGHT / 2 <= self.by <= py + self.PADDLE_HEIGHT / 2:
                    ...
                    if hit:
                        renpy.sound.play("sounds/pong_minigame_sounds/pong_boop.opus", channel=1)
                        self.bspeed *= 1.10
            ...
            elif self.bx > width-self.PADDLE_X:
                self.winner = "player"
                renpy.timeout(0)
        ...
        def event(self, ev, x, y, st):
            ...
            y = max(y, self.COURT_TOP+self.PADDLE_HEIGHT/2)
            y = min(y, self.COURT_BOTTOM-self.PADDLE_HEIGHT/2)
            self.playery = y
